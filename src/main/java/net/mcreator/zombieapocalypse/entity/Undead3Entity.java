...
public class Undead3Entity extends ZombieApocalypseModElements.ModElement {
	public static EntityType entity = null;
	public Undead3Entity(ZombieApocalypseModElements instance) {
		super(instance, 6);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire().size(0.6f, 1.8f))
						.build("undead_3").setRegistryName("undead_3");
		elements.entities.add(() -> entity);
		elements.items.add(() -> new SpawnEggItem(entity, -16692442, -16508551, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("undead_3_spawn_egg"));
	}

	@SubscribeEvent
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		event.getSpawns().getSpawner(EntityClassification.MONSTER).add(new MobSpawnInfo.Spawners(entity, 100, 5, 8));
	}
	...
	private static class GlowingLayer<T extends Entity, M extends EntityModel<T>> extends LayerRenderer<T, M> {
		...
		public void render(MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn, T entitylivingbaseIn, float limbSwing,
			...
			IVertexBuilder ivertexbuilder = bufferIn.getBuffer(RenderType.getEyes(new ResourceLocation("zombie_apocalypse:textures/glow3.png")));
