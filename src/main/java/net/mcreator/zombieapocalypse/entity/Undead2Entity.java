...
public class Undead2Entity extends ZombieApocalypseModElements.ModElement {
	public static EntityType entity = null;
	public Undead2Entity(ZombieApocalypseModElements instance) {
		super(instance, 3);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(0.6f, 1.8f)).build("undead_2")
						.setRegistryName("undead_2");
		elements.entities.add(() -> entity);
		elements.items.add(() -> new SpawnEggItem(entity, -16485829, -16767795, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("undead_2_spawn_egg"));
	}

	@SubscribeEvent
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		event.getSpawns().getSpawner(EntityClassification.MONSTER).add(new MobSpawnInfo.Spawners(entity, 250, 5, 8));
	}
	...
	public void init(FMLCommonSetupEvent event) {
		...
		EntitySpawnPlacementRegistry.register(entity, EntitySpawnPlacementRegistry.PlacementType.ON_GROUND, Heightmap.Type.MOTION_BLOCKING_NO_LEAVES,
				(entityType, world, reason, pos, random) -> {
					...
					int y = pos.getY();
					int z = pos.getZ();
					return Undead1NaturalEntitySpawningConditionProcedure.executeProcedure(ImmutableMap.of("world", world));
				});
	...
	private void setupAttributes() {
		...
		ammma = ammma.createMutableAttribute(Attributes.ARMOR, 0.9);
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public void playStepSound(BlockPos pos, BlockState blockIn) {
			this.playSound((net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("block.nether_bricks.step")),
					0.15f, 1);
		}
	...
	private static class GlowingLayer<T extends Entity, M extends EntityModel<T>> extends LayerRenderer<T, M> {
		...
		public void render(MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn, T entitylivingbaseIn, float limbSwing,
			...
			IVertexBuilder ivertexbuilder = bufferIn.getBuffer(RenderType.getEyes(new ResourceLocation("zombie_apocalypse:textures/glow1.png")));
