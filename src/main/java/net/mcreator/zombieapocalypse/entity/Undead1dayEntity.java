...
public class Undead1dayEntity extends ZombieApocalypseModElements.ModElement {
	public static EntityType entity = null;
	public Undead1dayEntity(ZombieApocalypseModElements instance) {
		super(instance, 8);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(0.6f, 1.8f)).build("undead_1day")
						.setRegistryName("undead_1day");
		elements.entities.add(() -> entity);
		elements.items.add(() -> new SpawnEggItem(entity, -16692442, -16508551, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("undead_1day_spawn_egg"));
	}
			...
			RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelzombie(), 0.5f) {
					...
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("zombie_apocalypse:textures/undead4tex.png");
					}
				};
			});
		}
