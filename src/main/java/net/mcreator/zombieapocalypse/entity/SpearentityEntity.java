...
import net.mcreator.zombieapocalypse.procedures.SpearentityRightClickedOnEntityProcedure;
...
public class SpearentityEntity extends ZombieApocalypseModElements.ModElement {
	public static EntityType entity = null;
	public SpearentityEntity(ZombieApocalypseModElements instance) {
		super(instance, 36);
	...
	private static class ModelRegisterHandler {
		...
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelspear(), 0.5f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("zombie_apocalypse:textures/spear.png");
					}
				};
			});
		}
	...
	private void setupAttributes() {
		...
		ammma = ammma.createMutableAttribute(Attributes.ARMOR, 37.800000000000004);
		ammma = ammma.createMutableAttribute(Attributes.ATTACK_DAMAGE, 3);
		ammma = ammma.createMutableAttribute(Attributes.KNOCKBACK_RESISTANCE, 25.5);
	...
	public static class CustomEntity extends CreatureEntity {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			experienceValue = 0;
			setNoAI(false);
			setCustomName(new StringTextComponent("right click to pick up"));
