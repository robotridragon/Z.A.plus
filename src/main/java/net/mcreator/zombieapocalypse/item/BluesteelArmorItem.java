...
public class BluesteelArmorItem extends ZombieApocalypseModElements.ModElement {
	@ObjectHolder("zombie_apocalypse:bluesteel_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("zombie_apocalypse:bluesteel_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("zombie_apocalypse:bluesteel_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("zombie_apocalypse:bluesteel_armor_boots")
	public static final Item boots = null;
	public BluesteelArmorItem(ZombieApocalypseModElements instance) {
		super(instance, 140);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(ItemGroup.COMBAT)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "zombie_apocalypse:textures/models/armor/bluesteel_layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
