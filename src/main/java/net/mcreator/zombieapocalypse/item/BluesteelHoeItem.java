...
public class BluesteelHoeItem extends ZombieApocalypseModElements.ModElement {
	@ObjectHolder("zombie_apocalypse:bluesteel_hoe")
	public static final Item block = null;
	public BluesteelHoeItem(ZombieApocalypseModElements instance) {
		super(instance, 134);
	}
