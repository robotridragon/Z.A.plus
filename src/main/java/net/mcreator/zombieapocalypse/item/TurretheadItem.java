...
public class TurretheadItem extends ZombieApocalypseModElements.ModElement {
	@ObjectHolder("zombie_apocalypse:turrethead")
	public static final Item block = null;
	public TurretheadItem(ZombieApocalypseModElements instance) {
		super(instance, 104);
	}
