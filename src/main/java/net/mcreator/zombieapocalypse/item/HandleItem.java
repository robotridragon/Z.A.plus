...
public class HandleItem extends ZombieApocalypseModElements.ModElement {
	@ObjectHolder("zombie_apocalypse:handle")
	public static final Item block = null;
	public HandleItem(ZombieApocalypseModElements instance) {
		super(instance, 30);
	}
