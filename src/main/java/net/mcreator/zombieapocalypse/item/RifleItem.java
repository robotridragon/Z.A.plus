...
public class RifleItem extends ZombieApocalypseModElements.ModElement {
	@ObjectHolder("zombie_apocalypse:rifle")
	public static final Item block = null;
	@ObjectHolder("zombie_apocalypse:entitybulletrifle")
	public static final EntityType arrow = null;
	public RifleItem(ZombieApocalypseModElements instance) {
		super(instance, 158);
	}
