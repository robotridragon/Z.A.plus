...
public class GunbarrelItem extends ZombieApocalypseModElements.ModElement {
	@ObjectHolder("zombie_apocalypse:gunbarrel")
	public static final Item block = null;
	public GunbarrelItem(ZombieApocalypseModElements instance) {
		super(instance, 101);
	}
