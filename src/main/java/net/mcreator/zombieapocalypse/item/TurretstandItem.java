...
public class TurretstandItem extends ZombieApocalypseModElements.ModElement {
	@ObjectHolder("zombie_apocalypse:turretstand")
	public static final Item block = null;
	public TurretstandItem(ZombieApocalypseModElements instance) {
		super(instance, 99);
	}
