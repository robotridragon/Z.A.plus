...
public class Ak47bullitdupeItem extends ZombieApocalypseModElements.ModElement {
	@ObjectHolder("zombie_apocalypse:ak_47bullitdupe")
	public static final Item block = null;
	@ObjectHolder("zombie_apocalypse:entitybulletak_47bullitdupe")
	public static final EntityType arrow = null;
	public Ak47bullitdupeItem(ZombieApocalypseModElements instance) {
		super(instance, 150);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybulletak_47bullitdupe").setRegistryName("entitybulletak_47bullitdupe"));
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			...
			setRegistryName("ak_47bullitdupe");
		}
		...
		public void onPlayerStoppedUsing(ItemStack itemstack, World world, LivingEntity entityLiving, int timeLeft) {
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (true) {
					ArrowCustomEntity entityarrow = shoot(world, entity, random, 6f, 2, 0);
