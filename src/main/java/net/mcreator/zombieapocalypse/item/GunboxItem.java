...
public class GunboxItem extends ZombieApocalypseModElements.ModElement {
	@ObjectHolder("zombie_apocalypse:gunbox")
	public static final Item block = null;
	public GunboxItem(ZombieApocalypseModElements instance) {
		super(instance, 100);
	}
