...
import net.mcreator.zombieapocalypse.procedures.BoosterRightClickedInAirProcedure;
import net.mcreator.zombieapocalypse.gui.TurretguiGuiWindow;
import net.mcreator.zombieapocalypse.gui.TurretguiGui;
...
public class BoosterItem extends ZombieApocalypseModElements.ModElement {
	@ObjectHolder("zombie_apocalypse:booster")
	public static final Item block = null;
	public BoosterItem(ZombieApocalypseModElements instance) {
		super(instance, 108);
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof TurretguiGuiWindow) {
	...
	public static class ItemCustom extends Item {
		...
		public ActionResult<ItemStack> onItemRightClick(World world, PlayerEntity entity, Hand hand) {
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Booster");
					}
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new TurretguiGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
			...
			}
			{
				...
				BoosterRightClickedInAirProcedure.executeProcedure($_dependencies);
			}
			return ar;
		}
