...
public class StoneknifeItem extends ZombieApocalypseModElements.ModElement {
	@ObjectHolder("zombie_apocalypse:stoneknife")
	public static final Item block = null;
	public StoneknifeItem(ZombieApocalypseModElements instance) {
		super(instance, 19);
	}
