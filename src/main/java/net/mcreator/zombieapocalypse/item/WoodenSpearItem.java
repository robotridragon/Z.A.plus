...
import net.mcreator.zombieapocalypse.procedures.WoodenSpearBulletHitsLivingEntityProcedure;
...
public class WoodenSpearItem extends ZombieApocalypseModElements.ModElement {
	@ObjectHolder("zombie_apocalypse:wooden_spear")
	public static final Item block = null;
	@ObjectHolder("zombie_apocalypse:entitybulletwooden_spear")
	public static final EntityType arrow = null;
	public WoodenSpearItem(ZombieApocalypseModElements instance) {
		super(instance, 36);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybulletwooden_spear").setRegistryName("entitybulletwooden_spear"));
	}
			...
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (true) {
					ItemStack stack = ShootableItem.getHeldAmmo(entity,
							e -> e.getItem() == new ItemStack(WoodenSpearItem.block, (int) (1)).getItem());
					if (stack == ItemStack.EMPTY) {
						for (int i = 0; i < entity.inventory.mainInventory.size(); i++) {
							ItemStack teststack = entity.inventory.mainInventory.get(i);
							if (teststack != null && teststack.getItem() == new ItemStack(WoodenSpearItem.block, (int) (1)).getItem()) {
								stack = teststack;
								break;
							}
						}
					...
					if (entity.abilities.isCreativeMode || stack != ItemStack.EMPTY) {
						...
						if (entity.abilities.isCreativeMode) {
							...
							if (new ItemStack(WoodenSpearItem.block, (int) (1)).isDamageable()) {
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		protected ItemStack getArrowStack() {
			return new ItemStack(WoodenSpearItem.block, (int) (1));
		}
		...
		protected void arrowHit(LivingEntity entity) {
			...
			World world = this.world;
			{
				...
				WoodenSpearBulletHitsLivingEntityProcedure.executeProcedure($_dependencies);
			}
		}
