...
public class Ak47ammoItem extends ZombieApocalypseModElements.ModElement {
	@ObjectHolder("zombie_apocalypse:ak_47ammo")
	public static final Item block = null;
	public Ak47ammoItem(ZombieApocalypseModElements instance) {
		super(instance, 151);
	}
