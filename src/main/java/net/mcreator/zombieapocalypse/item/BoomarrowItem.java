...
import net.mcreator.zombieapocalypse.procedures.PurevolatileitedropedProcedure;
...
public class BoomarrowItem extends ZombieApocalypseModElements.ModElement {
	@ObjectHolder("zombie_apocalypse:boomarrow")
	public static final Item block = null;
	@ObjectHolder("zombie_apocalypse:entitybulletboomarrow")
	public static final EntityType arrow = null;
	public BoomarrowItem(ZombieApocalypseModElements instance) {
		super(instance, 87);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybulletboomarrow").setRegistryName("entitybulletboomarrow"));
	}
			...
			if (this.inGround) {
				{
					...
					$_dependencies.put("z", z);
					$_dependencies.put("world", world);
					PurevolatileitedropedProcedure.executeProcedure($_dependencies);
				}
				this.remove();
			}
		}
