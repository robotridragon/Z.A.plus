...
public class FragmentitedustItem extends ZombieApocalypseModElements.ModElement {
	@ObjectHolder("zombie_apocalypse:fragmentitedust")
	public static final Item block = null;
	public FragmentitedustItem(ZombieApocalypseModElements instance) {
		super(instance, 62);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("fragmentitedust");
		}
