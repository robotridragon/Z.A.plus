...
public class VolatileiteBlockBlock extends ZombieApocalypseModElements.ModElement {
	@ObjectHolder("zombie_apocalypse:volatileite_block")
	public static final Block block = null;
	public VolatileiteBlockBlock(ZombieApocalypseModElements instance) {
		super(instance, 69);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("volatileite_block");
		}
